...
public class MabListener implements Listener {
	...
	public void CornerGrid(int r, int c, int rCount, int cCount, int heightTracker, int stage, Material[] buildList,
		...
		if (stage == 1) {
			...
			if (openings != 5 || oneWay == 1) {
				if (((cCount == 1 || cCount == 4 || cCount == 12 || cCount == 15) && rCount < 2)) {
					insert(0 + r, 0 + heightTracker, 0 + c, buildList[1], 0, 0, 0);
				}
			}

			if (openings != 5 || oneWay == 2) {
				if (((rCount == 1 || rCount == 4 || rCount == 12 || rCount == 15) && cCount < 2)) {
					insert(0 + r, 0 + heightTracker, 0 + c, buildList[1], 0, 0, 0);
				}
			}
		...
		if (stage == 2) {
			if (rCount == 0 && cCount < 16 && cCount > 0) {
				if ((openings != 5 || oneWay == 2) && openings != 2 && openings != 3 && openings != 4) {
					if (rCount % 2 == 0) {
						insert(0 + r, 0 + heightTracker, 0 + c, buildList[1], 0, 0, 0);
					} else {
						insert(0 + r, 0 + heightTracker, 0 + c, buildList[3], 2, 0, 0);
				...
				if ((openings != 5 || oneWay == 3) && openings != 4) {
					if (rCount % 2 == 0) {
						insert(0 + r, 0 + heightTracker, 0 + c, buildList[1], 0, 0, 0);
					} else {
						insert(0 + r, 0 + heightTracker, 0 + c, buildList[3], 2, 0, 0);
				...
				if ((openings != 5 || oneWay == 1) && openings != 2 && openings != 3 && openings != 4) {
					if (rCount % 2 == 0) {
						insert(0 + r, 0 + heightTracker, 0 + c, buildList[1], 0, 0, 0);
					} else {
						insert(0 + r, 0 + heightTracker, 0 + c, buildList[3], 2, 0, 0);
